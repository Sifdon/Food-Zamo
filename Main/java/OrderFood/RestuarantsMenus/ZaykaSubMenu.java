...
public class ZaykaSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurant Special",
            "Soups",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_zayka_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(ZaykaSubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/AARestaurantSpecial",
                      "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/Soups",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/BreakFastSnacks",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/Cutlet",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/Rolls",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/Chinese",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/Burger",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/Pizza",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/Sizzler",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/SouthIndian",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/PavBhaji",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/CholeBhature",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/Pasta",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/Salad",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/Raita",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/Vegetable",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/Rice",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/Dal",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/ShanETandoor",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/ComboMeals",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/Sundae",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Zayka/ThaliBhojan"
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(ZaykaSubMenu.this, Zayka.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(ZaykaSubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "Zayka");
                    startActivity(i);
