...
public class PunjabiChilliSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurant Special",
            "Soups(Veg)",
  ...
  TextView amount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_punjabi_chilli_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(PunjabiChilliSubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/AARestaurantSpecial",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/SoupsVeg",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/Starters",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/VegWraps",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/VegBurgers",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/SandWiches",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/Momos",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/Noodles",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/Pizza",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/PastaMarconi",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/CholeBhature",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/Platters",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/Combo",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/KhandeNaal",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/Rice",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/Biryani",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/SouthIndian",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/MainCourseVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/Roti",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/ParanteDiGali",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/PocketParanthe",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/NonVegSoups",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/NonVegStarters",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/Chopsey",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/NonVegBurgers",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/Italian",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/MainCourseNonVeg",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/PunjabiChilli/NonVegBiryani"
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(PunjabiChilliSubMenu.this, PunjabiChilli.class);
...
//upto_here
          ...
          proceed_button.setOnClickListener(new View.OnClickListener() {
              ...
              public void onClick(View v) {
                  ...
                  {
                      Intent i = new Intent(PunjabiChilliSubMenu.this,CheckOut.class);
                      i.putExtra("key", "The Punjabi Chilli");
                      startActivity(i);
    ...
    public void get_alert()
    {
        final AlertDialog alertDialog = new AlertDialog.Builder(
                PunjabiChilliSubMenu.this).create();
