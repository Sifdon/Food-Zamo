...
public class PavitraSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurant Special",
            "Chinese",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_pavitra_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(PavitraSubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Pavitra/AARestaurantSpecial",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Pavitra/Chinese",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Pavitra/Continental",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Pavitra/IndianFood",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Pavitra/Paratha",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Pavitra/Raita",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Pavitra/Rice",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Pavitra/Roti",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Pavitra/Salad",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Pavitra/Snacks",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Pavitra/SouthIndian",
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(PavitraSubMenu.this, Pavitra.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(PavitraSubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "Pavitra");
                    startActivity(i);
