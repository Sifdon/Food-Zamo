...
public class SaiBhojSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurant Special",
            "Dal",
...
//adding_new
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_sai_bhoj_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(SaiBhojSubMenu.this, web);
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(SaiBhojSubMenu.this, SaiBhoj.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(SaiBhojSubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "SaiBhoj");
                    startActivity(i);
