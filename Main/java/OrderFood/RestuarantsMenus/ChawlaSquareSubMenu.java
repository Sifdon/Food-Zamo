...
public class ChawlaSquareSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurant Special",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_chawla_square_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(ChawlaSquareSubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChawlaSquare/AARestaurantSpecial",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChawlaSquare/FromTheTandoorNonVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChawlaSquare/BonelessSnacks",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/ChawlaSquare/Fish",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChawlaSquare/ComboMealsSpecials",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChawlaSquare/FromTheHandiNonVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChawlaSquare/RiceBiryani",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChawlaSquare/SaladRaita",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChawlaSquare/FromTheTandoorVegSnacks",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChawlaSquare/MuttonFromHandi",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChawlaSquare/FromTheHandiVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChawlaSquare/Breads",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChawlaSquare/StuffedBreads"
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(ChawlaSquareSubMenu.this, ChawlaSquare.class);
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(ChawlaSquareSubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "Chawla Square");
                    startActivity(i);
    ...
    public void get_alert()
    {
        final AlertDialog alertDialog = new AlertDialog.Builder(
               ChawlaSquareSubMenu.this).create();
