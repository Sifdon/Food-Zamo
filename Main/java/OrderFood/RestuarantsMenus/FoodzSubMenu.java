...
public class FoodzSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurant Special",
            "Sandwich",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_foodz_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(FoodzSubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        "https://foodzamo-80ed4.firebaseio.com/Menus/FoodzInn/AARestaurantSpecial",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/FoodzInn/SandWich",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/FoodzInn/Chinese",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/FoodzInn/SouthIndian",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/FoodzInn/Soups",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/FoodzInn/SeasonalVeggies",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/FoodzInn/Dals",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/FoodzInn/RaitaCurd",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/FoodzInn/Rice",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/FoodzInn/Salad",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/FoodzInn/MainCourse",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/FoodzInn/RotiTandooriSe",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/FoodzInn/Papad",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/FoodzInn/Combos",
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(FoodzSubMenu.this, Foodz.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(FoodzSubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "Foodz Inn");
                    startActivity(i);
