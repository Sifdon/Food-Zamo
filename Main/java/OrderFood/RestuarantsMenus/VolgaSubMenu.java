...
public class VolgaSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurant Special",
            "Snacks",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_volga_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(VolgaSubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Volga/AARestaurantSpecial",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Volga/Snacks",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Volga/Soups",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Volga/SathSath",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Volga/Vegetarian",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Volga/Chicken",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Volga/Mutton",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Volga/Egg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Volga/ChoiceofRice",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Volga/Biryani",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Volga/RotiNaan",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/Volga/TandooriDelight",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Volga/Chinese",
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(VolgaSubMenu.this, Volga.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(VolgaSubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "Volga");
                    startActivity(i);
