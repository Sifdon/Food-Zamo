...
public class LuckySubMenu extends Activity {
    ListView list;
    String[] web = {
            "Biryani Special",
            "Chicken Special",
...
//adding_new
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_lucky_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(LuckySubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        "https://foodzamo-80ed4.firebaseio.com/Menus/LuckyChicken/Biryani Special",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/LuckyChicken/Chicken Special",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/LuckyChicken/Egg Curry",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/LuckyChicken/Fish Special",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/LuckyChicken/Mutton Special",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/LuckyChicken/RotiesNaan",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/LuckyChicken/TandooriSpecialities",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/LuckyChicken/Veg Curries",
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        {
                            Intent i = new Intent(LuckySubMenu.this, Lucky.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(LuckySubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "LuckyChicken");
                    startActivity(i);
