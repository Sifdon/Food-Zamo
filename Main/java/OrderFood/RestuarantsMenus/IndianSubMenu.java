...
public class IndianSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurant Special",
            "Chinese",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_indian_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(IndianSubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        "https://foodzamo-80ed4.firebaseio.com/Menus/IndianMeal/AARestaurantSpecial",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/IndianMeal/Chinese",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/IndianMeal/SouthIndian",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/IndianMeal/Soup",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/IndianMeal/Sweets",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/IndianMeal/Biryani",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/IndianMeal/Tandoori",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/IndianMeal/Pastries",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/IndianMeal/Maggie",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/IndianMeal/Papad",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/IndianMeal/HaribhariSabjiya",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/IndianMeal/Paneer",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/IndianMeal/Dal",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/IndianMeal/Chicken",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/IndianMeal/Egg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/IndianMeal/Roti",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/IndianMeal/Rice",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/IndianMeal/Snacks",
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(IndianSubMenu.this, Indian.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(IndianSubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "IndianMeal");
                    startActivity(i);
