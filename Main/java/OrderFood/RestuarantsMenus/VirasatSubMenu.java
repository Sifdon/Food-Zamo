...
public class VirasatSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurant Special",
            "Soups",
            ...
            "Fragrant Tender Chicken Delicacies",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_virasat_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(VirasatSubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Virasat/AARestaurantSpecial",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Virasat/Soups",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/Virasat/SideDishes",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Virasat/VegStarters",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/Virasat/NonVegStarters",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Virasat/Chinese",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/Virasat/Dal",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Virasat/DeliciousVegetableDishes",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Virasat/Chicken",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/Virasat/Mutton",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Virasat/Roti",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Virasat/Biryani",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/Virasat/Desserts",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Virasat/SaladRaita",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Virasat/SpecialThali"
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(VirasatSubMenu.this, Virasat.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(VirasatSubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "Virasat");
                    startActivity(i);
