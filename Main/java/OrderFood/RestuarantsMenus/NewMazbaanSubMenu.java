...
public class NewMazbaanSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurants Special",
            "Starter",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_new_mezbaan_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(NewMazbaanSubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        "https://foodzamo-80ed4.firebaseio.com/Menus/NewMezBaan/AARestaurantSpecial",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/NewMezBaan/Starters",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/NewMezBaan/Chowmin",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/NewMezBaan/Rice",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/NewMezBaan/Soup",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/NewMezBaan/Burgers",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/NewMezBaan/SouthIndian",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/NewMezBaan/Spring Roll",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/NewMezBaan/Pizzas",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/NewMezBaan/Roti",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/NewMezBaan/Rayta",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/NewMezBaan/Vegetarian",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/NewMezBaan/Papad",
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(NewMazbaanSubMenu.this, NewMazbaan.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(NewMazbaanSubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "New Mazbaan");
                    startActivity(i);
