...
public class RoyalSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurant Special",
            "Indian Snacks",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_royal_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(RoyalSubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        "https://foodzamo-80ed4.firebaseio.com/Menus/RoyalView/AARestaurantSpecial",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/RoyalView/SnacksIndian",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/RoyalView/ChineseSnacks",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/RoyalView/IndianMainCourse",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/RoyalView/Daal",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/RoyalView/ChineseMainCourse",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/RoyalView/IndianRice",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/RoyalView/IndianBreads",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/RoyalView/ChineseRiceNoodles",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/RoyalView/ComboMealChinese",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/RoyalView/Raita",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/RoyalView/SpecialSoyaChapTandoori",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/RoyalView/Gravy",
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(RoyalSubMenu.this, Royal.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(RoyalSubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "RoyalView");
                    startActivity(i);
