...
public class ThadkaSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurant Special",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_thadka_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(ThadkaSubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Thadka/AARestaurantSpecial",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Thadka/TandooriSpecaialities",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Thadka/ChickenSpecialities",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Thadka/FishSpecialities",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Thadka/Mutton",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Thadka/BiryaniSpecial",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Thadka/Bread",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Thadka/Salad",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Thadka/VegSpecialities",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Thadka/Snacks",
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(ThadkaSubMenu.this, Thadka.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(ThadkaSubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "Thadka");
                    startActivity(i);
