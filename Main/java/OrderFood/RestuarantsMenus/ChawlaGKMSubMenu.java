...
public class ChawlaGKMSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurants Special",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_chawla_gkmsub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(ChawlaGKMSubMenu.this, web);
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(ChawlaGKMSubMenu.this, ChawlaGKM.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(ChawlaGKMSubMenu.this,CheckOut.class);
                    //change_this
