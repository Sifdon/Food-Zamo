...
public class HakeemsSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurant Special",
            "Salad",
...
//adding_new
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_hakeems_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(HakeemsSubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/AARestaurantSpecial",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/Salad",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/SoupsVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/SoupsNonVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/SnacksVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/SoupsNonVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/ChineseVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/ChineseNonVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/NoodlesVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/NoodlesNonVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/Mutton",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/Eggs",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/Fish",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/Chicken",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/GreenVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/Dal",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/RiceVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/RiceNonVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/IndianBread",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Hakeems/Accompaniments",
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(HakeemsSubMenu.this, Hakeems.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(HakeemsSubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "Hakeems");
                    startActivity(i);
