...
public class ChopalChawlaSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurants Special",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_chopal_chawla_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(ChopalChawlaSubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChopalChawla/AARestaurantSpecial",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChopalChawla/Tandoori Specials",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChopalChawla/Chicken Specials",
                      "https://foodzamo-80ed4.firebaseio.com/Menus/ChopalChawla/Mutton Special",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/ChopalChawla/Fish Special",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/ChopalChawla/Biryani special",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChopalChawla/Soups",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChopalChawla/Bread Special",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChopalChawla/Salad",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/ChopalChawla/Veg Specialities",
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(ChopalChawlaSubMenu.this, ChopalChawla.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(ChopalChawlaSubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "Chopal Chawla");
                    startActivity(i);
    ...
    public void get_alert()
    {
        final AlertDialog alertDialog = new AlertDialog.Builder(
                ChopalChawlaSubMenu.this).create();
