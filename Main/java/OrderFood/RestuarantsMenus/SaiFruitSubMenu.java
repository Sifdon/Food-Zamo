...
public class SaiFruitSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurant Special",
            "Dal",
...
//adding_new
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_sai_fruit_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(SaiFruitSubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        "https://foodzamo-80ed4.firebaseio.com/Menus/SaiBhoj/AARestaurantSpecial",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/SaiBhoj/Dal",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/SaiBhoj/Papad",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/SaiBhoj/Raita",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/SaiBhoj/RicePulao",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/SaiBhoj/Salads",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/SaiBhoj/Snacks",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/SaiBhoj/Tandoori",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/SaiBhoj/Thali",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/SaiBhoj/Vegetable",
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(SaiFruitSubMenu.this, SaiFruit.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(SaiFruitSubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "SaiFruitSake");
                    startActivity(i);
