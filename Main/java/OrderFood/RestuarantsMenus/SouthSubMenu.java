...
public class SouthSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurant Special",
            "Snacks",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_south_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(SouthSubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        "https://foodzamo-80ed4.firebaseio.com/Menus/SouthExpress/AARestaurantSpecial",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/SouthExpress/Snacks",
                "https://foodzamo-80ed4.firebaseio.com/Menus/SouthExpress/IndianVegCurry",
                "https://foodzamo-80ed4.firebaseio.com/Menus/SouthExpress/IndianNonVegCurry",
                "https://foodzamo-80ed4.firebaseio.com/Menus/SouthExpress/TandooriVeg",
                "https://foodzamo-80ed4.firebaseio.com/Menus/SouthExpress/TandooriNonVeg",
                "https://foodzamo-80ed4.firebaseio.com/Menus/SouthExpress/IndianNonVegStarters",
                "https://foodzamo-80ed4.firebaseio.com/Menus/SouthExpress/ChineseVegStarters",
                "https://foodzamo-80ed4.firebaseio.com/Menus/SouthExpress/ChineseNonVegStarters",
                 "https://foodzamo-80ed4.firebaseio.com/Menus/SouthExpress/Biryani",
                 "https://foodzamo-80ed4.firebaseio.com/Menus/SouthExpress/ChineseFriedRiceVeg",
                 "https://foodzamo-80ed4.firebaseio.com/Menus/SouthExpress/ChineseFriedRiceNonVeg",
                 "https://foodzamo-80ed4.firebaseio.com/Menus/SouthExpress/Noodles",
                 "https://foodzamo-80ed4.firebaseio.com/Menus/SouthExpress/Roti",
                };
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(SouthSubMenu.this, South.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(SouthSubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "Shri South Express");
                    startActivity(i);
