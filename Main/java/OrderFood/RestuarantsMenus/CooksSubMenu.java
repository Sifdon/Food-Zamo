...
public class CooksSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurant Special",
            "Veg Pizza",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_cooks_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(CooksSubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/AARestaurantSpecial",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/PizzaVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/Burger",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/Rolls",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/Soups",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/Sandwich",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/Veg chineese",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/Veg Snacks",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/Parathas",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/QuickRollsPuffs",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/Pasta From Italy",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/Indian Curry Food",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/Veg Thali",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/Momos(Fried)",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/Sizzler",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/Chicken Pizza",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/Chicken BurgersRollsSnacks",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/Chicken Soups",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/Chicken Chinese",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Cooks/Chicken Indian Curry Food",
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(CooksSubMenu.this, Cooks.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(CooksSubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "Cooks FastFood");
                    startActivity(i);
