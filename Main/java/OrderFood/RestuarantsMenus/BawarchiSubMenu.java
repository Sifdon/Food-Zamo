...
public class BawarchiSubMenu extends Activity {
    ListView list;
    String[] web = {
            "RestuarantSpecial",
            "Idli",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_bawarchi_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(BawarchiSubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        ...
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/RestuarantSpecial",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/Idli",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/Soups",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/SnacksVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/SnacksNonVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/Chat",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/Dosa",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/Utappam",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/ChineseVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/ChineseNonVeg",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/MainCourse",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/RiceBiryani",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/Breads",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/ThaliBhojan",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/Sandwich",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/Noodles",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/Salads",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/Sweets",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Bawarchi/Pasteries"
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(BawarchiSubMenu.this, Bawarchi.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(BawarchiSubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "Bawarchi Xpress");
                    startActivity(i);
