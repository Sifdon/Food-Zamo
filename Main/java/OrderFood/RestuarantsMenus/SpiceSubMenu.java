...
public class SpiceSubMenu extends Activity {
    ListView list;
    String[] web = {
            "Restaurant Special",
            "Pizzas",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change_this
        setContentView(R.layout.activity_spice_sub_menu);
...
//upto_here
        ...
        CustomList adapter = new
                CustomList(SpiceSubMenu.this, web);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String[] url={
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Spice/AARestaurantSpecial",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/Spice/OurPizza",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Spice/Burgers",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Spice/HalkaFulka",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Spice/GardenGreen",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Spice/FromChinaTown",
                      "https://foodzamo-80ed4.firebaseio.com/Menus/Spice/EthenticSouthIndian",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Spice/DahikeRishtedar",
                       "https://foodzamo-80ed4.firebaseio.com/Menus/Spice/Rice",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Spice/TandooriSnacks",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Spice/NonVegetarian",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Spice/Vegetarian",
                        "https://foodzamo-80ed4.firebaseio.com/Menus/Spice/NaanRoti",
                ...
                databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if((s.length()<5))
                        {
                            ...
                            Intent i = new Intent(SpiceSubMenu.this, Spice.class);
...
//upto_here
        ...
        proceed_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i = new Intent(SpiceSubMenu.this,CheckOut.class);
                    //change_this
                    i.putExtra("key", "7 Spice");
                    startActivity(i);
